  ...
  const showNotification = useCallback((notification: FCMNotification) => {
    ...
    try {
      const notificationOptions: NotificationOptions = {
        ...
        ...(FCM_CONFIG.defaultNotificationOptions.vibrate && { vibrate: FCM_CONFIG.defaultNotificationOptions.vibrate }),
        ...(FCM_CONFIG.defaultNotificationOptions.requireInteraction !== undefined && { requireInteraction: FCM_CONFIG.defaultNotificationOptions.requireInteraction }),
        ...(FCM_CONFIG.defaultNotificationOptions.silent !== undefined && { silent: FCM_CONFIG.defaultNotificationOptions.silent }),
      };
