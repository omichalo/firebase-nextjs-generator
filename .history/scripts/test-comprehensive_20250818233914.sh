...
if npx ts-node "$REPO_ROOT/src/cli.ts" create --name test-minimal-mui --description "Test project MUI" --author "Test" --package-manager npm --nextjs-version 15 --ui mui --state-management zustand --features pwa --output ./test-output-minimal-mui --yes; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
...
if npx ts-node "$REPO_ROOT/src/cli.ts" create --name test-complete-mui-redux --description "Complete test project MUI + Redux" --author "Test" --package-manager npm --nextjs-version 15 --ui mui --state-management redux --features pwa,fcm,analytics,performance,sentry --output ./test-output-complete-mui-redux --yes; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
    ...
    TOTAL=$((TOTAL + 1))
    if [ -d "test-output-complete-mui-redux/frontend" ] && [ -d "test-output-complete-mui-redux/backend" ]; then
        echo -e "${GREEN}  PASS${NC}"
        PASSED=$((PASSED + 1))
    else
        echo -e "${RED}  FAIL${NC}"
    ...
    TOTAL=$((TOTAL + 1))
    if [ -f "test-output-complete-mui-redux/frontend/public/manifest.json" ] && [ -f "test-output-complete-mui-redux/frontend/src/app/page.tsx" ]; then
        echo -e "${GREEN}  PASS${NC}"
        PASSED=$((PASSED + 1))
    else
        echo -e "${RED}  FAIL${NC}"
    ...
    TOTAL=$((TOTAL + 1))
    if ! grep -r "{{.*}}" test-output-complete-mui-redux 2>/dev/null; then
        echo -e "${GREEN}  PASS${NC}"
        PASSED=$((PASSED + 1))
    else
        echo -e "${RED}  FAIL${NC}"
    ...
    TOTAL=$((TOTAL + 1))
    if grep -r "test-complete-mui-redux" test-output-complete-mui-redux >/dev/null 2>&1; then
        echo -e "${GREEN}  PASS${NC}"
        PASSED=$((PASSED + 1))
    else
        echo -e "${RED}  FAIL${NC}"
...
if npx ts-node "$REPO_ROOT/src/cli.ts" create --name test-yarn-14 --description "Test project Yarn Next.js 14" --author "Test" --package-manager yarn --nextjs-version 14 --ui mui --state-management zustand --features pwa --output ./test-output-yarn-14 --yes; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
...
TOTAL=$((TOTAL + 1))
if [ -d "test-output-minimal-mui" ] && [ -d "test-output-complete-mui-redux" ] && [ -d "test-output-yarn-14" ]; then
    if node -e "JSON.parse(require('fs').readFileSync('test-output-minimal-mui/frontend/package.json', 'utf8'))" 2>/dev/null && node -e "JSON.parse(require('fs').readFileSync('test-output-complete-mui-redux/frontend/package.json', 'utf8'))" 2>/dev/null && node -e "JSON.parse(require('fs').readFileSync('test-output-yarn-14/frontend/package.json', 'utf8'))" 2>/dev/null; then
        echo -e "${GREEN}  PASS${NC}"
        PASSED=$((PASSED + 1))
    else
        echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-complete-mui-redux/frontend/src/components/Button.tsx" ] && [ -f "test-output-complete-mui-redux/frontend/src/components/Card.tsx" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-complete-mui-redux/frontend/src/stores/auth-slice.ts" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
HBS_FILES=$(find test-output-minimal-mui test-output-complete-mui-redux test-output-yarn-14 -name "*.hbs" 2>/dev/null || true)
if [ -z "$HBS_FILES" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
...
TOTAL=$((TOTAL + 1))
if [ -d "test-output-minimal-mui/backend/functions" ] && [ -d "test-output-minimal-mui/backend/extensions" ] && [ -d "test-output-minimal-mui/backend/scripts" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -d "test-output-minimal-mui/backend/functions/src/auth" ] && [ -d "test-output-minimal-mui/backend/functions/src/firestore" ] && [ -d "test-output-minimal-mui/backend/functions/src/storage" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/backend/extensions/default/extension.yaml" ] && grep -q "name:" "test-output-minimal-mui/backend/extensions/default/extension.yaml"; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/backend/scripts/deploy.sh" ] && [ -f "test-output-minimal-mui/backend/scripts/deploy-dev.sh" ] && [ -x "test-output-minimal-mui/backend/scripts/deploy.sh" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if ! grep -r "{{.*}}" test-output-minimal-mui test-output-complete-mui-redux test-output-yarn-14 2>/dev/null; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
CRITICAL_TEMPLATES=(
    "test-output-minimal-mui/backend/firebase.json"
    "test-output-minimal-mui/backend/.firebaserc"
    "test-output-minimal-mui/backend/firestore.rules"
    "test-output-minimal-mui/frontend/package.json"
    "test-output-minimal-mui/frontend/next.config.js"
)
MISSING_TEMPLATES=0
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/frontend/.github/workflows/ci-cd.yml" ] && grep -q "name:" "test-output-minimal-mui/frontend/.github/workflows/ci-cd.yml" && grep -q "on:" "test-output-minimal-mui/frontend/.github/workflows/ci-cd.yml"; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/frontend/.github/workflows/ci-cd.yml" ] && grep -q "jobs:" "test-output-minimal-mui/frontend/.github/workflows/ci-cd.yml" && grep -q "steps:" "test-output-minimal-mui/frontend/.github/workflows/ci-cd.yml"; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -d "test-output-minimal-mui/backend/scripts" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
GENERATED_FILES_COUNT=$(find test-output-minimal-mui test-output-complete-mui-redux test-output-yarn-14 -type f -name "*.ts" -o -name "*.tsx" -o -name "*.js" -o -name "*.json" -o -name "*.yml" -o -name "*.yaml" -o -name "*.md" -o -name "*.sh" -o -name "*.bat" | wc -l)
...
TOTAL=$((TOTAL + 1))
TOTAL_SIZE=$(du -sk test-output-minimal-mui test-output-complete-mui-redux test-output-yarn-14 2>/dev/null | awk '{sum += $1} END {print sum}')
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/backend/firestore.rules" ] && grep -q "request.auth" "test-output-minimal-mui/backend/firestore.rules"; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/backend/storage.rules" ] && grep -q "request.auth" "test-output-minimal-mui/backend/storage.rules"; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if ! grep -r "eval(" test-output-minimal-mui test-output-complete-mui-redux test-output-yarn-14 2>/dev/null; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
if grep -r "useTranslation\|i18n\|locale" test-output-minimal-mui/frontend/src 2>/dev/null || [ -f "test-output-minimal-mui/frontend/next.config.js" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
...
if grep -r "Date\|toLocaleDateString\|format" test-output-minimal-mui/frontend/src 2>/dev/null || [ -f "test-output-minimal-mui/frontend/package.json" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
...
if grep -r "toLocaleString\|currency\|price" test-output-minimal-mui/frontend/src 2>/dev/null || [ -f "test-output-minimal-mui/frontend/package.json" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/frontend/next.config.js" ] && [ -f "test-output-minimal-mui/frontend/tsconfig.json" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/frontend/package.json" ] && grep -q '"next": "' test-output-minimal-mui/frontend/package.json; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/frontend/package.json" ] && grep -q '"name": "test-minimal-mui"' test-output-minimal-mui/frontend/package.json; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/backend/firestore.rules" ] && grep -q "rules_version" "test-output-minimal-mui/backend/firestore.rules" && grep -q "service cloud.firestore" "test-output-minimal-mui/backend/firestore.rules"; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/frontend/src/components/mui/Button.tsx" ] && grep -q "import.*@mui/material" "test-output-minimal-mui/frontend/src/components/mui/Button.tsx" && grep -q "export.*Button" "test-output-minimal-mui/frontend/src/components/mui/Button.tsx"; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/frontend/src/hooks/firebase/use-auth.ts" ] && grep -q "export.*useAuth" "test-output-minimal-mui/frontend/src/hooks/firebase/use-auth.ts" && grep -q "useState\|useEffect" "test-output-minimal-mui/frontend/src/hooks/firebase/use-auth.ts"; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/frontend/src/stores/zustand/auth-store.ts" ] && grep -q "create.*store" "test-output-minimal-mui/frontend/src/stores/zustand/auth-store.ts" && grep -q "export.*useAuthStore" "test-output-minimal-mui/frontend/src/stores/zustand/auth-store.ts"; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/frontend/next.config.js" ] && grep -q "module.exports" "test-output-minimal-mui/frontend/next.config.js" && [ -f "test-output-minimal-mui/frontend/tsconfig.json" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/frontend/public/manifest.json" ] && [ -f "test-output-minimal-mui/frontend/public/sw.js" ] && grep -q '"name"' "test-output-minimal-mui/frontend/public/manifest.json"; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
...
rm -rf test-output-minimal-mui test-output-complete-mui-redux test-output-yarn-14 test-error
