...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/backend/extensions/extension.yaml" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/backend/scripts/deploy.sh" ] && [ -f "test-output-minimal-mui/backend/scripts/deploy-env.sh" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/.github/workflows/ci-cd.yml" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
try {
  ...
  const fs = require('fs');
  const workflow = yaml.load(fs.readFileSync('test-output-minimal-mui/.github/workflows/ci-cd.yml', 'utf8'));
  console.log('PASS');
} catch (e) {
  console.log('FAIL');
}
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/backend/scripts/deploy.sh" ] && [ -x "test-output-minimal-mui/backend/scripts/deploy.sh" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/backend/scripts/deploy-env.sh" ] && [ -x "test-output-minimal-mui/backend/scripts/deploy-env.sh" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
