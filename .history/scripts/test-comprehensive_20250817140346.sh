...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/frontend/src/components/mui/Button.tsx" ] && [ -f "test-output-minimal-mui/frontend/src/components/mui/Card.tsx" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-complete-shadcn/frontend/src/components/shadcn/Button.tsx" ] && [ -f "test-output-complete-shadcn/frontend/src/components/shadcn/Card.tsx" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/frontend/src/stores/zustand/auth-store.ts" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-complete-shadcn/frontend/src/stores/redux/auth-slice.ts" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "test-output-minimal-mui/frontend/src/hooks/firebase/use-auth.ts" ] && [ -f "test-output-minimal-mui/frontend/src/hooks/ui/use-modal.ts" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
