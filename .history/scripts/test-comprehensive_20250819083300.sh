...
if npx ts-node "$REPO_ROOT/src/cli.ts" create --name test-minimal-mui --description "Test project MUI" --author "Test" --package-manager npm --nextjs-version 15 --ui mui --state-management zustand --features pwa --output "$TEST_BASE_DIR/test-output-minimal-mui" --yes; then
    ...
    TOTAL=$((TOTAL + 1))
    if [ -d "$TEST_BASE_DIR/$TEST_BASE_DIR/test-output-minimal-mui/frontend" ] && [ -d "$TEST_BASE_DIR/$TEST_BASE_DIR/test-output-minimal-mui/backend" ]; then
        echo -e "${GREEN}  PASS${NC}"
        PASSED=$((PASSED + 1))
    else
        echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "$TEST_BASE_DIR/test-output-minimal-mui/frontend/src/components/Button.tsx" ] && [ -f "$TEST_BASE_DIR/test-output-minimal-mui/frontend/src/components/Card.tsx" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "$TEST_BASE_DIR/test-output-minimal-mui/backend/extensions/default/extension.yaml" ] && grep -q "name:" "$TEST_BASE_DIR/test-output-minimal-mui/backend/extensions/default/extension.yaml"; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "$TEST_BASE_DIR/test-output-minimal-mui/backend/scripts/deploy.sh" ] && [ -f "$TEST_BASE_DIR/test-output-minimal-mui/backend/scripts/deploy-dev.sh" ] && [ -x "$TEST_BASE_DIR/test-output-minimal-mui/backend/scripts/deploy.sh" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "$TEST_BASE_DIR/test-output-minimal-mui/frontend/.github/workflows/ci-cd.yml" ] && grep -q "name:" "$TEST_BASE_DIR/test-output-minimal-mui/frontend/.github/workflows/ci-cd.yml" && grep -q "on:" "$TEST_BASE_DIR/test-output-minimal-mui/frontend/.github/workflows/ci-cd.yml"; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "$TEST_BASE_DIR/test-output-minimal-mui/backend/firestore.rules" ] && grep -q "rules_version" "$TEST_BASE_DIR/test-output-minimal-mui/backend/firestore.rules" && grep -q "service cloud.firestore" "$TEST_BASE_DIR/test-output-minimal-mui/backend/firestore.rules"; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "$TEST_BASE_DIR/test-output-minimal-mui/frontend/src/components/mui/Button.tsx" ] && grep -q "import.*@mui/material" "$TEST_BASE_DIR/test-output-minimal-mui/frontend/src/components/mui/Button.tsx" && grep -q "export.*Button" "$TEST_BASE_DIR/test-output-minimal-mui/frontend/src/components/mui/Button.tsx"; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "$TEST_BASE_DIR/test-output-minimal-mui/frontend/src/hooks/use-auth.ts" ] && grep -q "export.*useAuth" "$TEST_BASE_DIR/test-output-minimal-mui/frontend/src/hooks/use-auth.ts" && grep -q "useState\|useEffect" "$TEST_BASE_DIR/test-output-minimal-mui/frontend/src/hooks/use-auth.ts"; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if [ -f "$TEST_BASE_DIR/test-output-minimal-mui/frontend/src/stores/auth-store.ts" ] && grep -q "create.*store" "$TEST_BASE_DIR/test-output-minimal-mui/frontend/src/stores/auth-store.ts" && grep -q "export.*useAuthStore" "$TEST_BASE_DIR/test-output-minimal-mui/frontend/src/stores/auth-store.ts"; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
