...
#   TEST_OUTPUT_DIR=.custom-dir ./scripts/test.sh
...
export TEST_BASE_DIR="${ARTIFACTS_DIR}"
...
# Don't remove projects in TEST_BASE_DIR as they are managed by test-comprehensive.sh
