...
TOTAL=$((TOTAL + 1))
if [ -d "test-output-minimal-mui/frontend/src/locales" ] || [ -d "test-output-minimal-mui/frontend/public/locales" ]; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if grep -r "Intl.DateTimeFormat\|moment\|date-fns" test-output-minimal-mui/frontend/src 2>/dev/null; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
...
TOTAL=$((TOTAL + 1))
if grep -r "Intl.NumberFormat\|currency" test-output-minimal-mui/frontend/src 2>/dev/null; then
    echo -e "${GREEN}  PASS${NC}"
    PASSED=$((PASSED + 1))
else
    echo -e "${RED}  FAIL${NC}"
