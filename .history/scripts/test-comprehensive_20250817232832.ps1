...
try {
    ...
    $script:TOTAL++
    if ((Test-Path "test-output-complete-shadcn/frontend/public/manifest.json") -and (Test-Path "test-output-complete-shadcn/frontend/src/components/MUIWrapper.tsx")) {
        Write-Host "  PASS" -ForegroundColor $Green
        $script:PASSED++
    } else {
        Write-Host "  FAIL" -ForegroundColor $Red
...
$script:TOTAL++
if ((Test-Path "test-output-complete-shadcn/frontend/src/components/MUIWrapper.tsx") -and (Test-Path "test-output-complete-shadcn/frontend/src/components/Providers.tsx")) {
    Write-Host "  PASS" -ForegroundColor $Green
    $script:PASSED++
} else {
    Write-Host "  FAIL" -ForegroundColor $Red
...
$script:TOTAL++
if (Test-Path "test-output-complete-shadcn/frontend/src/stores/auth-slice.ts") {
    Write-Host "  PASS" -ForegroundColor $Green
    $script:PASSED++
} else {
    Write-Host "  FAIL" -ForegroundColor $Red
...
$script:TOTAL++
if ((Test-Path "test-output-minimal-mui/frontend/src/hooks/use-auth.ts") -and (Test-Path "test-output-minimal-mui/frontend/src/components/Button.tsx")) {
    Write-Host "  PASS" -ForegroundColor $Green
    $script:PASSED++
} else {
    Write-Host "  FAIL" -ForegroundColor $Red
