...
# Exécuter avec timeout et traces (compatible macOS)
debug_log "Starting test-ultra-deep.sh..."
if gtimeout 300 "$SCRIPT_DIR/test-ultra-deep.sh" > test-ultra-deep.log 2>&1 2>/dev/null || "$SCRIPT_DIR/test-ultra-deep.sh" > test-ultra-deep.log 2>&1; then
