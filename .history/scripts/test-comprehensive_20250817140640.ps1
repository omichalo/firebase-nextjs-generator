...
$script:TOTAL++
if ((Test-Path "test-output-minimal-mui/frontend/src/components/mui/Button.tsx") -and (Test-Path "test-output-minimal-mui/frontend/src/components/mui/Card.tsx")) {
    Write-Host "  PASS" -ForegroundColor $Green
    $script:PASSED++
} else {
    Write-Host "  FAIL" -ForegroundColor $Red
...
$script:TOTAL++
if ((Test-Path "test-output-complete-shadcn/frontend/src/components/shadcn/Button.tsx") -and (Test-Path "test-output-complete-shadcn/frontend/src/components/shadcn/Card.tsx")) {
    Write-Host "  PASS" -ForegroundColor $Green
    $script:PASSED++
} else {
    Write-Host "  FAIL" -ForegroundColor $Red
...
$script:TOTAL++
if (Test-Path "test-output-minimal-mui/frontend/src/stores/zustand/auth-store.ts") {
    Write-Host "  PASS" -ForegroundColor $Green
    $script:PASSED++
} else {
    Write-Host "  FAIL" -ForegroundColor $Red
