...
run_test "Generate minimal project" "npx ts-node src/cli.ts create --name test-minimal --description 'Test project' --author 'Test' --version '1.0.0' --package-manager npm --nextjs-version 15 --ui mui --state-management zustand --features pwa --output ./test-output-minimal --yes"
...
run_test "Generate complete project" "npx ts-node src/cli.ts create --name test-complete --description 'Complete test project' --author 'Test' --version '1.0.0' --package-manager npm --nextjs-version 15 --ui shadcn --state-management redux --features pwa,fcm,analytics,performance,sentry --output ./test-output-complete --yes"
