// Configuration PWA pour test-final-nextjs
export const PWA_CONFIG = {
  name: 'test-final-nextjs',
  shortName: 'test-final-nextjs',
  description: 'Test final Next.js config',
  startUrl: '/',
...
export const SW_CONFIG = {
  cacheName: 'test-final-nextjs-v1',
  urlsToCache: [
    '/',
    '/offline',
    '/manifest.json',
